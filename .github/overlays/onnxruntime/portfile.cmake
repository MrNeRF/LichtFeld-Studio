...
# ORT exposes a C ABI (header-only C++ wrapper), so release libs link safely into
# debug app builds; skipping the debug config halves a very expensive CUDA build.
...
if("cuda" IN_LIST FEATURES)
    ...
    # native needs a local GPU; CI runners must set LFS_ORT_CUDA_ARCHS explicitly.
    if(DEFINED ENV{LFS_ORT_CUDA_ARCHS})
        set(lfs_ort_cuda_archs "$ENV{LFS_ORT_CUDA_ARCHS}")
    else()
        set(lfs_ort_cuda_archs native)
    endif()
    list(APPEND FEATURE_OPTIONS
        "-DCMAKE_CUDA_COMPILER=${NVCC}"
        "-DCUDAToolkit_ROOT=${cuda_toolkit_root}"
        "-DCMAKE_CUDA_ARCHITECTURES=${lfs_ort_cuda_archs}"
