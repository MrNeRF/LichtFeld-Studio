...
namespace fast_lfs::optimizer {
    ...
    void quantize_adam_moments_raw(
        ...
        LFS_FASTGS_PHASE_CHECK("quantize_adam_moments");
    }
    ...
    void quantize_adam_moments_swizzled_raw(
        ...
        LFS_FASTGS_PHASE_CHECK("quantize_adam_moments_swizzled");
    }
    ...
    void zero_rows_at_indices(
        ...
        LFS_FASTGS_PHASE_CHECK("zero_rows_at_indices");
    }
    ...
    void zero_quantized_rows_at_indices(
        ...
        LFS_FASTGS_PHASE_CHECK("zero_quantized_rows_at_indices");
    }
