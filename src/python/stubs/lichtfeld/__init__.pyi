...
class OptimizationParams:
    ...
    @property
    def camera_pose_stop_step(self) -> int: ...

    @property
    def camera_pose_start_step(self) -> int: ...

    @camera_pose_start_step.setter
    def camera_pose_start_step(self, arg: int, /) -> None: ...

    @property
    def camera_pose_end_percent(self) -> int: ...

    @camera_pose_end_percent.setter
    def camera_pose_end_percent(self, arg: int, /) -> None: ...
