...
def clean_project_file(path: str | os.PathLike, destination: str | os.PathLike = '', expected_commit: str = '', progress: object | None = None, cancel: object | None = None) -> ProjectInspectorCard: ...
