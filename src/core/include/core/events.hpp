...
#define EVENT(Name, ...)                                   \
    ...
    namespace events {
        ...
        namespace cmd {
            ...
            EVENT(SequencerExportVideo, int width; int height; int framerate; int crf; std::string upscaler_backend = "native"; float upscaler_input_scale = 1.0f; int upscaler_quality = 1; int upscaler_fallback = 0; int splat_precision = 16; std::string path = {}; bool include_provenance = true;);
