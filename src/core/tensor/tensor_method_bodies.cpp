...
#undef LFS_DEFINE_SCALAR_CMP_OP
    ...
    template Tensor Tensor::add<float>(const float&) const;
    template Tensor Tensor::sub<float>(const float&) const;
    template Tensor Tensor::mul<float>(const float&) const;
    template Tensor Tensor::div<float>(const float&) const;
    template Tensor Tensor::pow<float>(const float&) const;
    template Tensor Tensor::mod<float>(const float&) const;
    template Tensor Tensor::maximum<float>(const float&) const;
    template Tensor Tensor::minimum<float>(const float&) const;
    template Tensor Tensor::eq<float>(const float&) const;
    template Tensor Tensor::ne<float>(const float&) const;
    template Tensor Tensor::lt<float>(const float&) const;
    template Tensor Tensor::le<float>(const float&) const;
    template Tensor Tensor::gt<float>(const float&) const;
    template Tensor Tensor::ge<float>(const float&) const;
    template Tensor& Tensor::add_<float>(const float&);
    template Tensor& Tensor::sub_<float>(const float&);
    template Tensor& Tensor::mul_<float>(const float&);
    template Tensor& Tensor::div_<float>(const float&);
    template Tensor Tensor::add<double>(const double&) const;
    template Tensor Tensor::sub<double>(const double&) const;
    template Tensor Tensor::mul<double>(const double&) const;
    template Tensor Tensor::div<double>(const double&) const;
    template Tensor Tensor::pow<double>(const double&) const;
    template Tensor Tensor::mod<double>(const double&) const;
    template Tensor Tensor::maximum<double>(const double&) const;
    template Tensor Tensor::minimum<double>(const double&) const;
    template Tensor Tensor::eq<double>(const double&) const;
    template Tensor Tensor::ne<double>(const double&) const;
    template Tensor Tensor::lt<double>(const double&) const;
    template Tensor Tensor::le<double>(const double&) const;
    template Tensor Tensor::gt<double>(const double&) const;
    template Tensor Tensor::ge<double>(const double&) const;
    template Tensor& Tensor::add_<double>(const double&);
    template Tensor& Tensor::sub_<double>(const double&);
    template Tensor& Tensor::mul_<double>(const double&);
    template Tensor& Tensor::div_<double>(const double&);
    template Tensor Tensor::add<int>(const int&) const;
    template Tensor Tensor::sub<int>(const int&) const;
    template Tensor Tensor::mul<int>(const int&) const;
    template Tensor Tensor::div<int>(const int&) const;
    template Tensor Tensor::pow<int>(const int&) const;
    template Tensor Tensor::mod<int>(const int&) const;
    template Tensor Tensor::maximum<int>(const int&) const;
    template Tensor Tensor::minimum<int>(const int&) const;
    template Tensor Tensor::eq<int>(const int&) const;
    template Tensor Tensor::ne<int>(const int&) const;
    template Tensor Tensor::lt<int>(const int&) const;
    template Tensor Tensor::le<int>(const int&) const;
    template Tensor Tensor::gt<int>(const int&) const;
    template Tensor Tensor::ge<int>(const int&) const;
    template Tensor& Tensor::add_<int>(const int&);
    template Tensor& Tensor::sub_<int>(const int&);
    template Tensor& Tensor::mul_<int>(const int&);
    template Tensor& Tensor::div_<int>(const int&);
    template Tensor Tensor::add<long>(const long&) const;
    template Tensor Tensor::sub<long>(const long&) const;
    template Tensor Tensor::mul<long>(const long&) const;
    template Tensor Tensor::div<long>(const long&) const;
    template Tensor Tensor::pow<long>(const long&) const;
    template Tensor Tensor::mod<long>(const long&) const;
    template Tensor Tensor::maximum<long>(const long&) const;
    template Tensor Tensor::minimum<long>(const long&) const;
    template Tensor Tensor::eq<long>(const long&) const;
    template Tensor Tensor::ne<long>(const long&) const;
    template Tensor Tensor::lt<long>(const long&) const;
    template Tensor Tensor::le<long>(const long&) const;
    template Tensor Tensor::gt<long>(const long&) const;
    template Tensor Tensor::ge<long>(const long&) const;
    template Tensor& Tensor::add_<long>(const long&);
    template Tensor& Tensor::sub_<long>(const long&);
    template Tensor& Tensor::mul_<long>(const long&);
    template Tensor& Tensor::div_<long>(const long&);
    template Tensor Tensor::add<long long>(const long long&) const;
    template Tensor Tensor::sub<long long>(const long long&) const;
    template Tensor Tensor::mul<long long>(const long long&) const;
    template Tensor Tensor::div<long long>(const long long&) const;
    template Tensor Tensor::pow<long long>(const long long&) const;
    template Tensor Tensor::mod<long long>(const long long&) const;
    template Tensor Tensor::maximum<long long>(const long long&) const;
    template Tensor Tensor::minimum<long long>(const long long&) const;
    template Tensor Tensor::eq<long long>(const long long&) const;
    template Tensor Tensor::ne<long long>(const long long&) const;
    template Tensor Tensor::lt<long long>(const long long&) const;
    template Tensor Tensor::le<long long>(const long long&) const;
    template Tensor Tensor::gt<long long>(const long long&) const;
    template Tensor Tensor::ge<long long>(const long long&) const;
    template Tensor& Tensor::add_<long long>(const long long&);
    template Tensor& Tensor::sub_<long long>(const long long&);
    template Tensor& Tensor::mul_<long long>(const long long&);
    template Tensor& Tensor::div_<long long>(const long long&);
    template Tensor Tensor::add<unsigned>(const unsigned&) const;
    template Tensor Tensor::sub<unsigned>(const unsigned&) const;
    template Tensor Tensor::mul<unsigned>(const unsigned&) const;
    template Tensor Tensor::div<unsigned>(const unsigned&) const;
    template Tensor Tensor::pow<unsigned>(const unsigned&) const;
    template Tensor Tensor::mod<unsigned>(const unsigned&) const;
    template Tensor Tensor::maximum<unsigned>(const unsigned&) const;
    template Tensor Tensor::minimum<unsigned>(const unsigned&) const;
    template Tensor Tensor::eq<unsigned>(const unsigned&) const;
    template Tensor Tensor::ne<unsigned>(const unsigned&) const;
    template Tensor Tensor::lt<unsigned>(const unsigned&) const;
    template Tensor Tensor::le<unsigned>(const unsigned&) const;
    template Tensor Tensor::gt<unsigned>(const unsigned&) const;
    template Tensor Tensor::ge<unsigned>(const unsigned&) const;
    template Tensor& Tensor::add_<unsigned>(const unsigned&);
    template Tensor& Tensor::sub_<unsigned>(const unsigned&);
    template Tensor& Tensor::mul_<unsigned>(const unsigned&);
    template Tensor& Tensor::div_<unsigned>(const unsigned&);
    template Tensor Tensor::add<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::sub<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::mul<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::div<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::pow<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::mod<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::maximum<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::minimum<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::eq<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::ne<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::lt<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::le<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::gt<unsigned long>(const unsigned long&) const;
    template Tensor Tensor::ge<unsigned long>(const unsigned long&) const;
    template Tensor& Tensor::add_<unsigned long>(const unsigned long&);
    template Tensor& Tensor::sub_<unsigned long>(const unsigned long&);
    template Tensor& Tensor::mul_<unsigned long>(const unsigned long&);
    template Tensor& Tensor::div_<unsigned long>(const unsigned long&);
    template Tensor Tensor::add<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::sub<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::mul<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::div<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::pow<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::mod<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::maximum<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::minimum<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::eq<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::ne<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::lt<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::le<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::gt<unsigned long long>(const unsigned long long&) const;
    template Tensor Tensor::ge<unsigned long long>(const unsigned long long&) const;
    template Tensor& Tensor::add_<unsigned long long>(const unsigned long long&);
    template Tensor& Tensor::sub_<unsigned long long>(const unsigned long long&);
    template Tensor& Tensor::mul_<unsigned long long>(const unsigned long long&);
    template Tensor& Tensor::div_<unsigned long long>(const unsigned long long&);
    template Tensor Tensor::add<short>(const short&) const;
    template Tensor Tensor::sub<short>(const short&) const;
    template Tensor Tensor::mul<short>(const short&) const;
    template Tensor Tensor::div<short>(const short&) const;
    template Tensor Tensor::pow<short>(const short&) const;
    template Tensor Tensor::mod<short>(const short&) const;
    template Tensor Tensor::maximum<short>(const short&) const;
    template Tensor Tensor::minimum<short>(const short&) const;
    template Tensor Tensor::eq<short>(const short&) const;
    template Tensor Tensor::ne<short>(const short&) const;
    template Tensor Tensor::lt<short>(const short&) const;
    template Tensor Tensor::le<short>(const short&) const;
    template Tensor Tensor::gt<short>(const short&) const;
    template Tensor Tensor::ge<short>(const short&) const;
    template Tensor& Tensor::add_<short>(const short&);
    template Tensor& Tensor::sub_<short>(const short&);
    template Tensor& Tensor::mul_<short>(const short&);
    template Tensor& Tensor::div_<short>(const short&);
    template Tensor Tensor::add<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::sub<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::mul<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::div<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::pow<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::mod<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::maximum<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::minimum<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::eq<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::ne<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::lt<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::le<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::gt<unsigned short>(const unsigned short&) const;
    template Tensor Tensor::ge<unsigned short>(const unsigned short&) const;
    template Tensor& Tensor::add_<unsigned short>(const unsigned short&);
    template Tensor& Tensor::sub_<unsigned short>(const unsigned short&);
    template Tensor& Tensor::mul_<unsigned short>(const unsigned short&);
    template Tensor& Tensor::div_<unsigned short>(const unsigned short&);
    template Tensor Tensor::add<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::sub<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::mul<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::div<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::pow<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::mod<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::maximum<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::minimum<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::eq<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::ne<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::lt<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::le<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::gt<unsigned char>(const unsigned char&) const;
    template Tensor Tensor::ge<unsigned char>(const unsigned char&) const;
    template Tensor& Tensor::add_<unsigned char>(const unsigned char&);
    template Tensor& Tensor::sub_<unsigned char>(const unsigned char&);
    template Tensor& Tensor::mul_<unsigned char>(const unsigned char&);
    template Tensor& Tensor::div_<unsigned char>(const unsigned char&);
    template Tensor Tensor::add<signed char>(const signed char&) const;
    template Tensor Tensor::sub<signed char>(const signed char&) const;
    template Tensor Tensor::mul<signed char>(const signed char&) const;
    template Tensor Tensor::div<signed char>(const signed char&) const;
    template Tensor Tensor::pow<signed char>(const signed char&) const;
    template Tensor Tensor::mod<signed char>(const signed char&) const;
    template Tensor Tensor::maximum<signed char>(const signed char&) const;
    template Tensor Tensor::minimum<signed char>(const signed char&) const;
    template Tensor Tensor::eq<signed char>(const signed char&) const;
    template Tensor Tensor::ne<signed char>(const signed char&) const;
    template Tensor Tensor::lt<signed char>(const signed char&) const;
    template Tensor Tensor::le<signed char>(const signed char&) const;
    template Tensor Tensor::gt<signed char>(const signed char&) const;
    template Tensor Tensor::ge<signed char>(const signed char&) const;
    template Tensor& Tensor::add_<signed char>(const signed char&);
    template Tensor& Tensor::sub_<signed char>(const signed char&);
    template Tensor& Tensor::mul_<signed char>(const signed char&);
    template Tensor& Tensor::div_<signed char>(const signed char&);
    template Tensor& Tensor::add_<Tensor>(const Tensor&);
    template Tensor& Tensor::sub_<Tensor>(const Tensor&);
    template Tensor& Tensor::mul_<Tensor>(const Tensor&);
    template Tensor& Tensor::div_<Tensor>(const Tensor&);
    template float Tensor::item<float>() const;
    template double Tensor::item<double>() const;
    template int Tensor::item<int>() const;
    template long Tensor::item<long>() const;
    template long long Tensor::item<long long>() const;
