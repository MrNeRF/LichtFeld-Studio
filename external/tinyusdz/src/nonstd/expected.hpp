...
nsel_DISABLE_MSVC_WARNINGS(26409)
    ...
    namespace expected_lite {
        ...
        namespace detail {
            ...
            template <typename FnT, typename ClassT, typename ObjectT, typename... Args nsel_REQUIRES_T(std::is_function<FnT>::value && (std::is_same<ClassT, typename std20::remove_cvref<ObjectT>::type>::value || std::is_base_of<ClassT, typename std20::remove_cvref<ObjectT>::type>::value))>
            nsel_constexpr auto invoke_member_function_impl(FnT ClassT::*memfnptr, ObjectT&& obj, Args&&... args) noexcept(noexcept((std::forward<ObjectT>(obj).*memfnptr)(std::forward<Args>(args)...)))
            ...
            template <typename FnT, typename ClassT, typename ObjectT, typename... Args nsel_REQUIRES_T(std::is_function<FnT>::value&& is_reference_wrapper<typename std20::remove_cvref<ObjectT>::type>::value)>
            nsel_constexpr auto invoke_member_function_impl(FnT ClassT::*memfnptr, ObjectT&& obj, Args&&... args) noexcept(noexcept((obj.get().*memfnptr)(std::forward<Args>(args)...)))
                -> decltype((obj.get().*memfnptr)(std::forward<Args>(args)...)) {
                return (obj.get().*memfnptr)(std::forward<Args>(args)...);
            }

            template <typename FnT, typename ClassT, typename ObjectT, typename... Args nsel_REQUIRES_T(std::is_function<FnT>::value && !std::is_same<ClassT, typename std20::remove_cvref<ObjectT>::type>::value && !std::is_base_of<ClassT, typename std20::remove_cvref<ObjectT>::type>::value && !is_reference_wrapper<typename std20::remove_cvref<ObjectT>::type>::value)>
            nsel_constexpr auto invoke_member_function_impl(FnT ClassT::*memfnptr, ObjectT&& obj, Args&&... args) noexcept(noexcept(((*std::forward<ObjectT>(obj)).*memfnptr)(std::forward<Args>(args)...)))
                -> decltype(((*std::forward<ObjectT>(obj)).*memfnptr)(std::forward<Args>(args)...)) {
                return ((*std::forward<ObjectT>(obj)).*memfnptr)(std::forward<Args>(args)...);
            }

            template <typename MemberT, typename ClassT, typename ObjectT nsel_REQUIRES_T(std::is_same<ClassT, typename std20::remove_cvref<ObjectT>::type>::value || std::is_base_of<ClassT, typename std20::remove_cvref<ObjectT>::type>::value)>
            nsel_constexpr auto invoke_member_object_impl(MemberT ClassT::*memobjptr, ObjectT&& obj) noexcept(noexcept(std::forward<ObjectT>(obj).*memobjptr))
                -> decltype(std::forward<ObjectT>(obj).*memobjptr) {
                return std::forward<ObjectT>(obj).*memobjptr;
            }

            template <typename MemberT, typename ClassT, typename ObjectT nsel_REQUIRES_T(is_reference_wrapper<typename std20::remove_cvref<ObjectT>::type>::value)>
            nsel_constexpr auto invoke_member_object_impl(MemberT ClassT::*memobjptr, ObjectT&& obj) noexcept(noexcept(obj.get().*memobjptr))
                -> decltype(obj.get().*memobjptr) {
                return obj.get().*memobjptr;
            }

            template <typename MemberT, typename ClassT, typename ObjectT nsel_REQUIRES_T(!std::is_same<ClassT, typename std20::remove_cvref<ObjectT>::type>::value && !std::is_base_of<ClassT, typename std20::remove_cvref<ObjectT>::type>::value && !is_reference_wrapper<typename std20::remove_cvref<ObjectT>::type>::value)>
            nsel_constexpr auto invoke_member_object_impl(MemberT ClassT::*memobjptr, ObjectT&& obj) noexcept(noexcept((*std::forward<ObjectT>(obj)).*memobjptr))
                -> decltype((*std::forward<ObjectT>(obj)).*memobjptr) {
                return (*std::forward<ObjectT>(obj)).*memobjptr;
            }
            ...
            nsel_constexpr auto invoke(F&& f, Args&&... args) noexcept(noexcept(invoke_member_function_impl(std::forward<F>(f), std::forward<Args>(args)...)))
            ...
            nsel_constexpr auto invoke(F&& f, Args&&... args) noexcept(noexcept(invoke_member_object_impl(std::forward<F>(f), std::forward<Args>(args)...)))
            ...
            template <typename F, typename... Args
                                      nsel_REQUIRES_T(
                                          !std::is_member_function_pointer<typename std20::remove_cvref<F>::type>::value && !std::is_member_object_pointer<typename std20::remove_cvref<F>::type>::value)>
            nsel_constexpr auto invoke(F&& f, Args&&... args) noexcept(noexcept(std::forward<F>(f)(std::forward<Args>(args)...)))
        ...
        public:
            ...
            template <typename E2
                          nsel_REQUIRES_T(
                              std::is_constructible<E, E2>::value && !std::is_same<typename std20::remove_cvref<E2>::type, nonstd_lite_in_place_t(E2)>::value && !std::is_same<typename std20::remove_cvref<E2>::type, unexpected_type>::value)>
            constexpr explicit unexpected_type(E2&& error)
                : m_error(std::forward<E2>(error)) {}

            template <typename E2
                          nsel_REQUIRES_T(
                              std::is_constructible<E, E2>::value && !std::is_constructible<E, unexpected_type<E2>&>::value && !std::is_constructible<E, unexpected_type<E2>>::value && !std::is_constructible<E, unexpected_type<E2> const&>::value && !std::is_constructible<E, unexpected_type<E2> const>::value && !std::is_convertible<unexpected_type<E2>&, E>::value && !std::is_convertible<unexpected_type<E2>, E>::value && !std::is_convertible<unexpected_type<E2> const&, E>::value && !std::is_convertible<unexpected_type<E2> const, E>::value && !std::is_convertible<E2 const&, E>::value /*=> explicit */
                              )>
        ...
        namespace detail {
            ...
            struct valid_unexpected_type : std::integral_constant<bool,
                                                                  std::is_same<T, typename std20::remove_cvref<T>::type>::value && std::is_object<T>::value && !std::is_array<T>::value> {};
    ...
    namespace expected_lite {
        ...
        public:
            ...
            template <typename U = T
                          nsel_REQUIRES_T(
                              std::is_constructible<T, U&&>::value && !std::is_same<typename std20::remove_cvref<U>::type, nonstd_lite_in_place_t(U)>::value && !std::is_same<expected<T, E>, typename std20::remove_cvref<U>::type>::value && !std::is_same<nonstd::unexpected_type<E>, typename std20::remove_cvref<U>::type>::value && !std::is_convertible<U&&, T>::value /*=> explicit */
                              )>
            ...
            template <typename U = T
                          nsel_REQUIRES_T(
                              std::is_constructible<T, U&&>::value && !std::is_same<typename std20::remove_cvref<U>::type, nonstd_lite_in_place_t(U)>::value && !std::is_same<expected<T, E>, typename std20::remove_cvref<U>::type>::value && !std::is_same<nonstd::unexpected_type<E>, typename std20::remove_cvref<U>::type>::value && std::is_convertible<U&&, T>::value /*=> non-explicit */
                              )>
            ...
            template <typename G = E
                          nsel_REQUIRES_T(
                              std::is_constructible<E, G const&>::value && !std::is_convertible<G const&, E>::value /*=> explicit */
                              )>
            ...
            template <typename G = E
                          nsel_REQUIRES_T(
                              std::is_constructible<E, G const&>::value&& std::is_convertible<G const&, E>::value /*=> non-explicit */
                              )>
            ...
            template <typename G = E
                          nsel_REQUIRES_T(
                              std::is_constructible<E, G&&>::value && !std::is_convertible<G&&, E>::value /*=> explicit */
                              )>
            ...
            expected& operator=(expected&& other) noexcept(
                std::is_nothrow_move_constructible<T>::value && std::is_nothrow_move_assignable<T>::value && std::is_nothrow_move_constructible<E>::value // added for missing
            ...
            template <typename U
                          nsel_REQUIRES_T(
                              !std::is_same<expected<T, E>, typename std20::remove_cvref<U>::type>::value && std17::conjunction<std::is_scalar<T>, std::is_same<T, std::decay<U>>>::value && std::is_constructible<T, U>::value && std::is_assignable<T&, U>::value && std::is_nothrow_move_constructible<E>::value)>
            ...
            nsel_REQUIRES_R(void,
                            std17::is_swappable<U>::value&& std17::is_swappable<G>::value && (std::is_move_constructible<U>::value || std::is_move_constructible<G>::value))
            ...
            template <typename G = E
                          nsel_REQUIRES_T(
                              std::is_copy_constructible<E>::value&& std::is_convertible<G, E>::value)>
            ...
            template <typename G = E
                          nsel_REQUIRES_T(
                              std::is_move_constructible<E>::value&& std::is_convertible<G, E>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, value_type&>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F, value_type&>::error_type, error_type>::value&& std::is_constructible<error_type, error_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, const value_type&>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F, const value_type&>::error_type, error_type>::value&& std::is_constructible<error_type, const error_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, error_type&>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F, error_type&>::value_type, value_type>::value&& std::is_constructible<value_type, value_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, const error_type&>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F, const error_type&>::value_type, value_type>::value&& std::is_constructible<value_type, const value_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, error_type&>::value && !std::is_void<detail::transform_invoke_result_t<F, value_type&>>::value && detail::valid_expected_value_type<detail::transform_invoke_result_t<F, value_type&>>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, error_type&>::value&& std::is_void<detail::transform_invoke_result_t<F, value_type&>>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, const error_type&>::value && !std::is_void<detail::transform_invoke_result_t<F, const value_type&>>::value && detail::valid_expected_value_type<detail::transform_invoke_result_t<F, const value_type&>>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, const error_type&>::value&& std::is_void<detail::transform_invoke_result_t<F, const value_type&>>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::valid_unexpected_type<detail::transform_invoke_result_t<F, error_type&>>::value&& std::is_constructible<value_type, value_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::valid_unexpected_type<detail::transform_invoke_result_t<F, const error_type&>>::value&& std::is_constructible<value_type, const value_type&>::value)>
        ...
        private:
            detail::storage_t<
                T, E, std::is_copy_constructible<T>::value && std::is_copy_constructible<E>::value, std::is_move_constructible<T>::value && std::is_move_constructible<E>::value>
                contained;
        };
        ...
        public:
            ...
            template <typename G = E>
            nsel_REQUIRES_R(void,
                            std17::is_swappable<G>::value&& std::is_move_constructible<G>::value)
                swap(expected& other) noexcept(
                    std::is_nothrow_move_constructible<E>::value && std17::is_nothrow_swappable<E&>::value) {
                using std::swap;
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F>::error_type, error_type>::value&& std::is_constructible<error_type, error_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F>>::value&& std::is_same<typename detail::invoke_result_nocvref_t<F>::error_type, error_type>::value&& std::is_constructible<error_type, const error_type&>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, error_type&>>::value&& std::is_void<typename detail::invoke_result_nocvref_t<F, error_type&>::value_type>::value)>
            nsel_constexpr14 detail::invoke_result_nocvref_t<F, error_type&> or_else(F&& f) & {
                return has_value()
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              detail::is_expected<detail::invoke_result_nocvref_t<F, const error_type&>>::value&& std::is_void<typename detail::invoke_result_nocvref_t<F, const error_type&>::value_type>::value)>
            nsel_constexpr detail::invoke_result_nocvref_t<F, const error_type&> or_else(F&& f) const& {
                return has_value()
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, error_type&>::value && !std::is_void<detail::transform_invoke_result_t<F>>::value)>
            ...
            template <typename F
                          nsel_REQUIRES_T(
                              std::is_constructible<error_type, const error_type&>::value && !std::is_void<detail::transform_invoke_result_t<F>>::value)>
        ...
        private:
            detail::storage_t<
                void, E, std::is_copy_constructible<E>::value, std::is_move_constructible<E>::value>
                contained;
        };

        // x.x.4.6 expected<>: comparison operators

        template <typename T1, typename E1, typename T2, typename E2 nsel_REQUIRES_T(!std::is_void<T1>::value && !std::is_void<T2>::value)>
        constexpr bool operator==(expected<T1, E1> const& x, expected<T2, E2> const& y) {
            return bool(x) != bool(y) ? false : bool(x) ? *x == *y
                                                        : x.error() == y.error();
        }
        ...
        template <typename T, typename E
                                  nsel_REQUIRES_T(
                                      (std::is_void<T>::value || std::is_move_constructible<T>::value) && std::is_move_constructible<E>::value && std17::is_swappable<T>::value && std17::is_swappable<E>::value)>
